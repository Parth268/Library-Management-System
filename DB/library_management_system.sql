...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 12, 2020 at 07:23 PM
...
INSERT INTO `books` (`b_id`, `b_name`, `b_code`, `b_author`, `b_sem`, `b_dept`, `b_price`, `b_count`) VALUES
(8, 'Android', 9, 'MH. sir', 8, 'Computer', 100, 3),
(13, 'xyz', 45, 'abc', 5, 'Computer', 56, 4),
(14, 'xyz', 35, 'abc', 6, 'Computer', 400, 4);
